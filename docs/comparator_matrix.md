...
| TRASH2 | Assembly tandem arrays and monomers | Author-designated early-development successor, evaluated separately from TRASH1 | Same offline control completed;360 monomer sequences match standard1-based coordinates; no plant-scale comparison yet |
