...
| --- | --- | --- |
| Engineering baseline | Full pytest; Rust tests and release build; output validation | Current source passes all 435 Python tests; unchanged Rust source passed 15 tests, fmt and clippy; both b85a266 hosted CI runs passed on Ubuntu and macOS; the new domain-shift checkpoint awaits hosted CI |
...
| Localization/comparison | Known array coordinates; engineered collapse levels; false collapse calls and boundary errors | Fresh 5201–5203 validation improved TP/FN/FP/TN from 198/45/14/148 to 208/35/12/150 with a frozen rule; a predeclared 1–5% unit-divergence and one/three-segment extension with unused 5401–5403 seeds is prepared; biological truth remains pending |
