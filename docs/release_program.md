...
| --- | --- | --- |
| Engineering baseline | Full pytest; Rust tests and release build; output validation | Commit 6863155 passed 505 local Python tests and hosted runs 34086256099/34086367490. The current compact replay-evidence checkpoint passes 510 Python tests. A complete same-machine replay retained byte-identical 5,940-row metrics and all 108 copy-number files while reducing full-matrix time 610.507→349.217 s; this remains an engineering check rather than publication timing |
