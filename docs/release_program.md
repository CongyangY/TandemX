...
| --- | --- | --- |
| Engineering baseline | Full pytest; Rust tests and release build; output validation | Current source passes all 462 Python tests; unchanged Rust source passed 15 tests, fmt and clippy; commit 300e48d and both hosted held-out-guard CI runs passed on Ubuntu and macOS; archive, figure and depth-gated-rule tests pass locally |
