...
| --- | --- | --- |
| Engineering baseline | Full pytest; Rust tests and release build; output validation | Current source passes all 452 Python tests; unchanged Rust source passed 15 tests, fmt and clippy; both 6a84644 hosted CI runs passed on Ubuntu and macOS; the multi-k recovery patch awaits its hosted checkpoint |
