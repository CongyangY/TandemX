...
| --- | --- | --- |
| Engineering baseline | Full pytest; Rust tests and release build; output validation | Commit 62892a6 passed hosted checks before the v3 held-out run; evidence commit 3b21825 passes all 470 Python tests locally and passed hosted Ubuntu/macOS Python, Rust and wheel runs 34047548628/34047562996 on the work branch and main |
