...
| --- | --- | --- |
| Engineering baseline | Full pytest; Rust tests and release build; output validation | Commit f47fc1a passed 510 local Python tests and hosted runs 34087474642/34087489635. The current validation-freeze checkpoint passes 514 Python tests. A complete same-machine replay retained byte-identical 5,940-row metrics and all 108 copy-number files while reducing full-matrix time 610.507→349.217 s; this remains an engineering check rather than publication timing |
