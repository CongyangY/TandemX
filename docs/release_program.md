...
| --- | --- | --- |
| Engineering baseline | Full pytest; Rust tests and release build; output validation | Current source passes all 442 Python tests; unchanged Rust source passed 15 tests, fmt and clippy; both 0c24b24 hosted CI runs passed on Ubuntu and macOS; domain-shift publication evidence and compact Morex reference archiving await the next hosted checkpoints |
