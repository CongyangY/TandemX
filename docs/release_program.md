...
| --- | --- | --- |
| Engineering baseline | Full pytest; Rust tests and release build; output validation | Current source passes all 447 Python tests; unchanged Rust source passed 15 tests, fmt and clippy; both ec81f15 hosted CI runs passed on Ubuntu and macOS; the predeclared held-out freeze guard awaits its hosted checkpoint |
