...
| --- | --- | --- |
| Engineering baseline | Full pytest; Rust tests and release build; output validation | Current source passes all 445 Python tests; unchanged Rust source passed 15 tests, fmt and clippy; both a10c309 hosted CI runs passed on Ubuntu and macOS; the localizer development source awaits the next hosted checkpoint |
