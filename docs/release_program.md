...
| --- | --- | --- |
| Engineering baseline | Full pytest; Rust tests and release build; output validation | Commit a73398d passes 472 local Python tests, Rust formatting and Clippy; hosted runs 34048998182/34049010825 passed Ubuntu/macOS Python, executable Rust and wheel jobs. Its exact-output elastic replay reduced one-replay runtime and RSS at 11/111 Mb while preserving six/seven products byte-identically. A later workspace tradeoff was rejected; restoration commit e760471 passed both platforms in 34050266939/34050278620. Repeated isolated timing remains pending |
| Challenge benchmark | Independent seeds; indels, unit divergence, mixed families, multiple arrays, short arrays, hard negatives; strict normalization | Native-screen cascade recovered every development scenario with lower time/RSS geometric means than elastic and is archived with hashes. A frozen 3101–3103 held-out matrix and executable promotion gates are committed locally but remain unconsumed until hosted CI passes |
