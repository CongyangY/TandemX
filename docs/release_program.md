...
| --- | --- | --- |
| Engineering baseline | Full pytest; Rust tests and release build; output validation | Current source passes all 426 Python tests; unchanged Rust source passed 15 tests, fmt and clippy at f16596b; both f16596b hosted CI runs passed, with new checkpoint CI pending |
...
| Localization/comparison | Known array coordinates; engineered collapse levels; false collapse calls and boundary errors | Predeclared 5101–5103 held-out conditional matrix completed: 208 TP/35 FN/8 FP/154 TN; 36/36 positive exact-copy localizations had base recall 1; divergent/fragmented arrays and biological truth remain pending |
...
| Innovation | Audited prior art; method ablations; held-out evaluation; AI retained only with reproducible benefit | A transparent multi-k/depth rule improved sensitivity, false-positive rate and precision on all development genomes; its hashes and fresh seeds 5201–5203 are frozen, with independent execution pending |
