...
| --- | --- | --- |
| Engineering baseline | Full pytest; Rust tests and release build; output validation | Commit 62892a6 passed hosted Ubuntu/macOS Python, Rust and wheel checks before the v3 held-out run; the current evidence archive and Figure 7 source pass all 470 Python tests, with hosted CI pending for this evidence checkpoint |
