...
| Software quality | Current source passes 459 Python tests; unchanged Rust source passed 15 tests, Clippy and formatting; 300e48d passed hosted Ubuntu/macOS CI before held-out execution | Verify the new compact archiver/figure tests in hosted CI; production defaults, clean install/release verification, workflow portability and complete command validation |
