...
| Software quality | Current source passes 447 Python tests; unchanged Rust source passed 15 tests, Clippy and formatting; ec81f15 passed hosted Ubuntu/macOS CI | Hosted CI for the predeclared held-out freeze guard; production defaults, clean install/release verification, workflow portability and complete command validation |
