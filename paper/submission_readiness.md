...
| Software quality | Current source passes 438 Python tests; unchanged Rust source passed 15 tests, Clippy and formatting; 0c24b24 passed hosted Ubuntu/macOS CI | Hosted CI for the domain-shift figure and narrative; production defaults, clean install/release verification, workflow portability and complete command validation |
