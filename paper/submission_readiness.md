...
| Multi-panel figures | Five inspected six-panel figures, including frozen-rule validation and ten-library QC; two four-panel single-library QC figures | Isolated repeated comparative scaling and biological-validation figures; visual/source QA of final package |
...
| Assembly interpretation | Frozen transparent rule improved fresh-seed sensitivity 81.48%→85.60%, false-positive rate 8.64%→7.41% and precision 93.40%→94.55%; difficult-condition recall 3/9→9/9; the predeclared 5401–5403 divergence/fragmentation baseline completed | Frozen-rule domain-shift evaluation, seed-5202 false positives, biological under-representation and donor-matched validation remain unresolved |
...
| Software quality | Current source passes 437 Python tests; unchanged Rust source passed 15 tests, Clippy and formatting; c15dad7 passed hosted Ubuntu/macOS CI | Hosted CI for expanded evidence archivers, production defaults, clean install/release verification, workflow portability and complete command validation |
