...
| Software quality | Current source passes 452 Python tests; unchanged Rust source passed 15 tests, Clippy and formatting; 6a84644 passed hosted Ubuntu/macOS CI | Hosted CI for the multi-k recovery patch; production defaults, clean install/release verification, workflow portability and complete command validation |
| GitHub/reuse | 6a84644 pushed to main and working branch; classifier pre-registration, held-out localizer validation, YSD56 full QC and figure evidence are published; both hosted CI runs passed | Multi-k recovery patch needs the next verified commit/push; clean release, portability and archive deposition remain pending |
