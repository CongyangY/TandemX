...
| Assembly interpretation | Frozen transparent rule improved fresh-seed sensitivity 81.48%→85.60%, false-positive rate 8.64%→7.41% and precision 93.40%→94.55%; difficult-condition recall 3/9→9/9; an unused-seed divergence/fragmentation test is predeclared | Seed-5202 false positives, execution of the 5401–5403 domain-shift matrix, biological under-representation and donor-matched validation remain unresolved |
...
| Software quality | Current source passes 435 Python tests; unchanged Rust source passed 15 tests, Clippy and formatting in b85a266 hosted CI | Hosted CI for the domain-shift checkpoint, production defaults, clean install/release verification, workflow portability and complete command validation |
