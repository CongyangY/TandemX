...
| Fair comparators | TRF/TideHunter executed; TRASH1/2 task-specific evaluations; real source-query recovery and threshold sensitivity; native alternatives/failed parsing retained. TideCluster 1.21.2 has a pinned image, planted-truth smoke and hash-archived nested 10/100-Mb MorexV3 reference-window runs with six-panel resource/provenance QA | Whole-genome and accuracy-matched TideCluster, further applicable tools, donor-matched truth, controlled sensitivity settings and isolated repeated cross-tool resource comparisons |
