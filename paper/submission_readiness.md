...
| Software quality | Current source passes 446 Python tests; unchanged Rust source passed 15 tests, Clippy and formatting; 837ea63 passed hosted Ubuntu/macOS CI | Hosted CI for the bounded-gap localizer revision; production defaults, clean install/release verification, workflow portability and complete command validation |
