...
| Software quality | Current source passes 445 Python tests; unchanged Rust source passed 15 tests, Clippy and formatting; a10c309 passed hosted Ubuntu/macOS CI | Hosted CI for the localizer development source; production defaults, clean install/release verification, workflow portability and complete command validation |
