...
results remain visible. All nine tool executions and normalizations succeeded.
...
motivate an explicitly selectable exact-related audit policy. That policy needs
its own output-equivalence and resource measurements before a benefit claim.
